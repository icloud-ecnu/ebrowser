...
void ContentViewCoreImpl::OnGestureEventAck(const blink::WebGestureEvent& event,
  ...
  switch (event.type) {
    ...
    case WebInputEvent::GestureScrollUpdate:
      if (ack_result == INPUT_EVENT_ACK_STATE_CONSUMED){
	//LOG(INFO)<<"INPUT_EVENT_ACK_STATE_CONSUMED";
...
WebGestureEvent ContentViewCoreImpl::MakeGestureEvent(WebInputEvent::Type type,
                                                      ...
                                                      float x,
                                                      float y) const {
 //LOG(INFO)<<"######################################################ContentViewCore::SendGestureEvent";
...
//LOG(INFO)<<"######################################################ContentViewCore::ScrollBegin";
...
void ContentViewCoreImpl::ScrollEnd(JNIEnv* env,
                                    const JavaParamRef<jobject>& obj,
                                    jlong time_ms) {
//LOG(INFO)<<"######################################################ContentViewCore::ScrollEnd";
  WebGestureEvent event = MakeGestureEvent(
...
void ContentViewCoreImpl::ScrollBy(JNIEnv* env,
                                   ...
                                   jfloat dx,
                                   jfloat dy) {
//LOG(INFO)<<"######################################################ContentViewCore::ScrollBy";
  WebGestureEvent event = MakeGestureEvent(
...
//LOG(INFO)<<"event.data.flingStart.velocityY))))))))))))))))))))"<<event.data.flingStart.velocityY;
  SendGestureEvent(event);
}

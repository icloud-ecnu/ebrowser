...
bool InputRouterImpl::SendInput(std::unique_ptr<IPC::Message> message) {
  ...
  //LOG(INFO)<<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~InputRouterImpl::SendInput";
  switch (message->type()) {
...
void InputRouterImpl::SendGestureEvent(
  ...
  //LOG(INFO)<<"~~~~~~~~~~~~~~~~~~~~~~~~~~~InputRouterImpl::SendGestureEvent";
  ...
  //float v = gesture_event.data.flingStart.velocityY;
 // LOG(INFO)<<"~~~~~~~~~~当前速度:"<<fabs(v);
...
//LOG(INFO)<<"~~~~~~~~~~~~~~~~~~~~~~~~~~~InputRouterImpl::SendGestureEventImmediately";
...
bool InputRouterImpl::OfferToRenderer(const WebInputEvent& input_event,
  ...
  DCHECK(input_event.type != blink::WebInputEvent::GestureFlingStart ||
    ...
    /*float v = static_cast<const blink::WebGestureEvent&>(input_event)
                 .data.flingStart.velocityY;
      
    LOG(INFO)<<"当前速度OfferToRenderer:"<<fabs(v);*/
  ...
  //LOG(INFO)<<"device_scale_factor_------------"<<device_scale_factor_;
  const WebInputEvent* event_to_send =
      event_in_viewport ? event_in_viewport.get() : &input_event;
  //LOG(INFO)<<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~Send(new InputMsg_HandleInputEvent";
